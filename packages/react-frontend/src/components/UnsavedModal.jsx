...
export default function UnsavedModal({ onDiscard, onCancel }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-[10px] pt-[16px] px-[14px]">
          <div className="bg-[#fef0c7] relative rounded-[20px] size-[40px] flex items-center justify-center">
            <div className="absolute border-4 border-[#fffaeb] inset-[-3px] rounded-[23px]" />
            <AlertCircle
              className="size-[20px] text-orange-600 relative z-10"
              strokeWidth={2}
            />
          </div>
